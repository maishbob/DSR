...
function deleteTransaction(t) {
    if (!confirm(`Delete POS transaction ${t.reference} — KES ${fmt(t.amount)}?`)) return;
    ...
    <AuthenticatedLayout>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-5">
            <div class="bg-white rounded-xl shadow-sm p-4 border-l-4 border-blue-500">
                ...
                <p class="text-2xl font-bold text-gray-800">{{ transactions.length }}</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tfoot v-if="transactions?.length" class="bg-gray-50 border-t-2 border-gray-300">
                        <tr>
